...
- 2020-05-26 Tue 16:45 - 新增执行脚本 =update.sh= ，原因详见 [[*%E5%85%B3%E4%BA%8E%E6%89%A7%E8%A1%8C%E8%84%9A%E6%9C%AC][关于执行脚本]]
...
#+BEGIN_EXPORT html
<div class="jk-essay">
期间，由于 Windows 上的 Emacs 性能问题，我又去折腾了一段时间 Hugo ，主题什么的全部 DIY 了一套，结果，开始写博文的时候，又不可避免的回到了 Emacs ，没办法，还是这个顺手……
</div>
#+END_EXPORT
  ...
  (use-package ox-publish
    ...
    (setq org-publish-project-alist
          '(("orgfiles"
            ...
            ("images"
             :base-directory "~/site/images/ost/"
             :base-extension "jpg\\|gif\\|png\\|svg\\|gif"
             :publishing-directory "~/site/public/images/ost/"
             :recursive t
             :publishing-function org-publish-attachment
             )
            ("assets"
...
#+BEGIN_EXAMPLE
  ...
  # key: ii
  # --
  <img src="images/ost/$1" width="${2:6}0%" />
#+END_EXAMPLE
